...
const Quote = (props) => {
  ...
  return (
    <div id='quoteMainDiv' key={key}>
        ...
        <div id='quoteBtnDiv'>
            <button id='likeBtn' className='quoteBtn'><i className="fa-regular fa-heart"></i></button>
            <button id='commentBtn' className='quoteBtn'><i className="fa-regular fa-comment"></i></button>
            <button id='shareBtn' className='quoteBtn'><i className="fa-sharp fa-solid fa-share"></i></button>
        </div>
    </div>
  )
}
